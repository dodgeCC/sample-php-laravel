        ...
        <div class="spark-screen container">
            <div class="row">
                ...
                <div class="col-md-3 spark-settings-tabs">
                    @if (Auth::user()->hasEnterpriseTeam() || Auth::user()->hasTeamInvitations() || Spark::usesTeams() && Auth::user()->canCreateTeams() && (Spark::createsAdditionalTeams() || Spark::showsTeamSwitcher()))
                    <aside>
              ...
              1-2 2-2h4V2c0-1 1-2 2-2s2 1 2 2v2h4c1 0 2 1 2 2v4h-2c-1 0-2 1-2 2s1 2 2 2h2z "></path>
                    ...
                    <!-- Billing Tabs -->
                    @if (Auth::user()->isCompany() && Spark::canBillCustomers() && !(!Auth::user()->subscribed() && Auth::user()->hasEnterpriseTeam() && !Auth::user()->ownsCurrentTeam()))
                        <aside>
                            <h3 class="nav-heading ">
                                {{__('Billing')}}
                            </h3>
