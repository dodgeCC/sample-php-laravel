                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item" href="{{ route('home') }}">
                                <i class="fa fa-fw text-left fa-btn fa-cog"></i> {{ config('app.name') }}
                            </a>

                            <!-- Dashboard -->
                            <h6 class="dropdown-header">{{__('Dashboard')}}</h6>

                            <a class="dropdown-item" href="{{ route(Auth::user()->getDashboardRoute()) }}">
                                <i class="fa fa-fw text-left fa-btn fa-cog"></i> {{__('Dashboard')}}
                            </a>
                            ...
                            <!-- Your Settings -->
                            @if (Auth::user()->hasEnterpriseTeam())
                            <a class="dropdown-item" href="/settings#/teams">
                            ...
                            @if (false && Spark::usesTeams() && Auth::user()->canCreateTeams() && (Spark::createsAdditionalTeams() || Spark::showsTeamSwitcher()))
                                <!-- Team Settings -->
