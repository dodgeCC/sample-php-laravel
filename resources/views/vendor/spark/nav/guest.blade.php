    ...
    <div class="container">
        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link @if(View::hasSection('navbar-light')) text-reset @else text-white @endif" href="{{ route('login') }}">{{__('Login')}}</a>
                </li>
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle dropdown-border-0 text-primary font-weight-bold" data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false">
                        Register
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg-right">
                        <a class="dropdown-item" href="{{ route('register', ['role'=>'candidate'])}}">{{__('Register As Candidate')}}</a>
                        <a class="dropdown-item" href="{{ route('register', ['role'=>'company'])}}">{{__('Register As Company')}}</a>
                    </div>
                </li>
            </ul>
        </div>
